...
const hi: Translations = {
    ...
    v2: {
        ...
        stats2Label: 'रीजन',
        stats3Value: '<60s',
        stats3Label: 'डिप्लॉय समय',
        stats4Value: '100%',
        stats4Label: 'अपटाइम SLA',
        pricingTitle: 'पारदर्शी मूल्य निर्धारण',
        planGrowthTagline: 'व्यक्तिगत परियोजनाओं और प्रयोगों के लिए',
        planProTagline: 'उत्पादन कार्यभार के लिए',
        planBusinessTagline: 'बढ़ते व्यवसायों के लिए',
