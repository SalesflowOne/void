...
const ru: Translations = {
    ...
    v2: {
        ...
        stats3Value: '<60s',
        stats3Label: 'Время Развёртывания',
        stats4Value: '100%',
        stats4Label: 'SLA Аптайма',
        pricingTitle: 'Прозрачные Цены',
        planGrowthTagline: 'Для личных проектов и экспериментов',
        planProTagline: 'Для производственных нагрузок',
        planBusinessTagline: 'Для растущего бизнеса',
