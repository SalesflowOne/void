...
import type { AgentDiagnosticsContentProps } from '@/ts/Interfaces'
...
import { useAgentDiagnostics, useRepairAgent } from '@/hooks'
import { PanelPlaceholder, LiveBadge } from '@/components/shared'
import { useUIStore } from '@/lib/store'
import { TOAST_TYPE } from '@/lib/constants'

const AgentDiagnosticsContent: FC<AgentDiagnosticsContentProps> = ({
    agentId,
    enabled,
    mockData
}): ReactNode => {
    const query = useAgentDiagnostics(agentId, enabled && !mockData)
...
export default AgentDiagnosticsContent